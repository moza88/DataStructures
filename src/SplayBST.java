...
public class SplayBST<Key extends Comparable<Key>, Value>  {
    ...
    *************************************************************************/
    ...
    public static void main(String[] args) {
        ...
        st.put("New Girl", "Fox");
        st.put("Homeland", "Showtime");
        st.put("Broadwalk Empire", "HBO");
        st.put("Breaking Bad",    "AMC");
        st.put("Glee",         "FOX");
        System.out.println("The size 0 is: " + st.size());
        System.out.println(st.get("Glee"));
                
        st.remove("Homeland");
        if (st.contains("Homeland")) {
            System.out.println("Homeland wasn't successfully deleted");
        }
        else System.out.println("Homeland was successfully deleted");


        System.out.println(st.root.toString());
        System.out.println(st.root.toString());

        st.postOrderTraverseTree(st.root);
